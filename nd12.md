...
```bash
$ sudo apt install -y git curl wget nodejs npm sqlite3 libsqlite3-dev m4 libssl-dev zlib1g-dev cmdtest build-essential imagemagick libreadline-dev direnv
...
# DER形式の秘密鍵を16進文字列(上位ニブルが先) 形式にして確認する
...
claim={
	...
	sub: '12345',
	aud: 'client.com',
	iat: '2022/12/09 15:23:55',
	exp: '2022/12/10 15:23:55'
}
```

## 近畿大学のGoogle OAuth2 による共通認証システム
...
URL:   http://＜IPアドレス＞:3000/

で Rails のページが表示されれば成功
