...
$ sudo apt install -y make nodejs npm gcc ruby ruby-dev libxml2 libxml2-dev libssl-dev sqlite3 libsqlite3-dev zlib1g-dev direnv
...
$ sudo gem install omniauth-google-oauth2
$ sudo gem install omniauth-rails_csrf_protection
```
