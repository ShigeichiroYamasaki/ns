...
```
john -wordlist:/usr/share/dict/words -users:userx p.txt
```
...
```
# 123123 というパスワードの SHA-256 ハッシュの場合
...
# kindai というパスワードの SHA-256 ハッシュの場合

echo -n kindai | sha256sum                       
1822f18c3c1ed1402a044d517550f1526b9ff1cf5e21763031ed6a2bb71b544c

dcipher 1822f18c3c1ed1402a044d517550f1526b9ff1cf5e21763031ed6a2bb71b544c
✔ kindai
```

パスワードにアルファベットと数字を混ぜた場合

```
echo -n kindai123 | sha256sum                              
a4757e4d323ee5b7357cf62e1a4bd7f11aa9c362ec98cf65406116981bbd218c
