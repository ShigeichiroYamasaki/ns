...
```bash 
$ echo -n nasubitomatoninjin | sha256sum                       

fdb481ea956fdb654afcc327cff9b626966b2abdabc3f3e6dbcb1667a888ed9a

$ dcipher cd1490da57f37e4a476c33292b2664cbcca60eb575eb5a31f902a940460b65b2
✖ Hash could not be deciphered
```
...
apt ではなく，ソースコードをコンパイルしてインストールします．
